...
const { process_params } = require("express/lib/router");
 ...
 this.on("READ", Risks, async (req, next) => {
    /* Check wheater the request wants an "expand" of the business partner
   ...
   /*
   Instead of carrying out the expand, issue a seperate request for each business partner
